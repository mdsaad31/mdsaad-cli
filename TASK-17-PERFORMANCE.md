...
this.resourcePools.set('ascii-art', { maxSize: 50, items: new Map(), accessCount: new Map() });
this.resourcePools.set('api-responses', { maxSize: 100, items: new Map(), accessCount: new Map() });
```
